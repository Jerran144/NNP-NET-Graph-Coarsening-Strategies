...
private:
  ...
  void solarSystemIteration(Graph<float> &in, Graph<float> &out,
                            ...
                            std::vector<int> &outNodes, int target = 0);
  int fastSubnetworkIteration(Graph<float> &in, Graph<float> &out,
                              std::vector<int> &inNodes,
                              std::vector<int> &outNodes, int target,
                              int startPos = 0);
  void getFastSubnetworkOrder(Graph<float> &g,
